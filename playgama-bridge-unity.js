...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/SOCCER 2026.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/SOCCER 2026.data.unityweb',
                        frameworkUrl: 'Build/SOCCER 2026.framework.js.unityweb',
                        codeUrl: 'Build/SOCCER 2026.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: '3S Games',
                        productName: 'SOCCER 2026',
